...
import com.springframework.samples.petclinic.models.PetType;
...
//import com.springframework.samples.petclinic.pet.repo.PetRepository;
...
public class PetTypeFormatter implements Formatter<PetType> {
    ...
    public PetType parse(String text, Locale locale) throws ParseException {
    	...
    	Collection<PetType> findPetTypes = Arrays.asList(results); 
